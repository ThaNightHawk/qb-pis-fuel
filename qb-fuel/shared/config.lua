...
Config.EmergencyServicesDiscount = {
    ...
    ['discount'] = 20, -- % Discount off of price.
...
Config.JerryCanCap = 20 -- Maximum amount (in L) the jerrycan can fit! (Default: 50L)
Config.JerryCanPrice = (Config.JerryCanCap * Config.CostMultiplier) -- The price of a jerry can, not including tax.
Config.JerryCanGas = 20 -- The amount of Gas that the Jerry Can you purchase comes with. This should not be bigger that your Config.JerryCanCap!
...
Config.MaxFuelPrice = 18 -- This is the maximum value you want to let players set their fuel prices to.
...
Config.AirAndWaterVehicleFueling = {
    ...
    ['locations'] = {
        ...
        [1] = {
            ...
            ['draw_text'] = "[G] Genopfyld helikopter",
            ['type'] = 'air',
            ['whitelist'] = {
                ['enabled'] = true,
                ['on_duty_only'] = true,
        ...
        [4] = {
            ...
            ['draw_text'] = "[G] Genopfyld luftfaretøj",
            ['type'] = 'air',
            ['whitelist'] = {
                ['enabled'] = false,
                ['on_duty_only'] = false,
        ...
        [8] = {
            ...
            ['draw_text'] = "[G] Genopfyld båd/jetski",
            ['type'] = 'water',
            ['whitelist'] = {
                ['enabled'] = false,
                ['on_duty_only'] = false,
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [28] = { -- Car Meet Location, Line In If Needed.
        zones = {
