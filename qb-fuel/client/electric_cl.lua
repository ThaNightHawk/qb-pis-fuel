    ...
    RegisterNetEvent('qb-fuel:client:electric:FinalMenu', function(purchasetype)
        ...
        if Config.Ox.Input then
            Electricity = lib.inputDialog('Electric Charger', {
                { type = "input", label = 'El pris',
                default = FuelPrice .. ',- /KWh',
                disabled = true },
                { type = "input", label = 'Nuværende opladning',
                default = finalfuel .. ' KWh',
                disabled = true },
                { type = "input", label = 'Krævet maksimal opladning',
                default = maxfuel,
                disabled = true },
                { type = "slider", label = 'Fuld opladning: ' ..wholetankcostwithtax.. ',-',
                default = maxfuel,
                min = 0,
                max = maxfuel
                },
            ...
            Electricity = exports['qb-input']:ShowInput({
                header = "Vælg hvor meget du vil oplade<br>Pris: " ..
                FuelPrice .. ",- / KWh <br> Nuværrende opladning: " .. finalfuel .. " KWh <br> Fuld opladning: " ..
                ...
                inputs = {{
                    ...
                    isRequired = true,
                    name = 'amount',
                    text = 'Batteriet kan holde ' .. maxfuel .. ' KWh mere.'
                }}
            })
            if Electricity then
